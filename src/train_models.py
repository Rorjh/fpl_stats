...
train_x = train.drop(["gw_points"], axis=1).values
train_y = train[["gw_points"]].values.ravel()
test_x = test.drop(["gw_points"], axis=1).values
test_y = test[["gw_points"]].values.ravel()
...
mlflow.set_experiment("/predicted_points")
